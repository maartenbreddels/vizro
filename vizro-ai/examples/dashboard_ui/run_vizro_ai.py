...
def run_vizro_ai_dashboard(user_prompt, data, model, api_key, api_base, n_clicks):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--arg3", required=True, help="Model")
    parser.add_argument("--arg4", required=True, help="API key")
    parser.add_argument("--arg5", required=True, help="API base")
    parser.add_argument("--arg6", required=True, help="n_clicks")

    args = parser.parse_args()

    run_vizro_ai_dashboard(args.arg1, args.arg2, args.arg3, args.arg4, args.arg5, args.arg6)
