...
class VizroAIDashboard:
    def __init__(self, model, fig_builder):
        self.model = model
    ...
    ":hammer_and_wrench::hammer_and_wrench::hammer_and_wrench: Aye! Starting to build your nonsense... :hammer_and_wrench::hammer_and_wrench::hammer_and_wrench: \n"))
        dashboard = DashboardBuilder(model=self.model, data=df, dashboard_plan=self.dashboard_plan,
                                     fig_builder=self.fig_builder).dashboard
        return dashboard